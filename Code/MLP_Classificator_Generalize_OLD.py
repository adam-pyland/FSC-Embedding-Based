...
if TARGET_NOVEL_CLASS == 'ExtremelyLongHeavyDutyTraileronly':
    ...
    ALL_CLASSES.remove('ExtremelyLongHeavyDutyTraileronly')
    ALL_CLASSES.remove('Forklifts')
    TRAIN_NOVEL_DIR = f'{data_path}/Obj_Embs/train/{TARGET_NOVEL_CLASS}_{SHOTS}_shots/'
    VAL_NOVEL_DIR   = f'{data_path}/Obj_Embs/test/novel_class_{TARGET_NOVEL_CLASS}_{SHOTS}_shots/'
